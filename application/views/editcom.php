  ...
  <div class="content-wrapper">
    ...
    <div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo ucwords('edit company') ?></h3>
			</div>
			<div class="panel-body">
				<?php foreach($company as $c){?>
				<form action="<?php echo base_url('C_company/update') ?>" method="post">
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
								<input type="hidden" name="id" value="<?php echo $c->id_company ?>">
								<input type="text" class="form-control" placeholder="Company Name" name="name" value="<?php echo $c->name_company ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
								<input type="text" class="form-control" placeholder="Email" name="email" value="<?php echo $c->email_company ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
								<input type="text" class="form-control" placeholder="Web" name="web" value="<?php echo $c->web_company ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
